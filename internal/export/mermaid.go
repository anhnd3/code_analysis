...
// MermaidService renders ReviewFlow as mermaid sequence diagram.
type MermaidService struct{}

// NewMermaidService creates a new MermaidService instance.
func NewMermaidService() MermaidService {
	return MermaidService{}
}

// Render renders the flow review as a mermaid sequence diagram.
func (MermaidService) Render(flow facts.ReviewFlow) string {
