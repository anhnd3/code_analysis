...
func fileImportAliases(file ParsedGoFile) map[string]string {
...
func structFieldsMatchingType(files []ParsedGoFile, matchesType func(string, map[string]string) bool) map[string]map[string]bool {
