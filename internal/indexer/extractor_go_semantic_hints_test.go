...
func semanticHintsFile(t *testing.T, name string) FileRef {
	t.Helper()
...
func mustFindSymbol(t *testing.T, symbols []Symbol, canonical string) Symbol {
	t.Helper()
...
func mustFindHint(t *testing.T, hints []Hint, kind HintKind) Hint {
	t.Helper()
	matches := []Hint{}
...
func hasHint(hints []Hint, kind HintKind) bool {
	for _, hint := range hints {
		if hint.Kind == kind {
			return true
		}
...
func TestExtractorEmitsReturnHandlerHint(t *testing.T) {
	...
	hint := mustFindHint(t, result.Hints, HintReturnHandler)
...
func TestExtractorEmitsInlineSpawnHint(t *testing.T) {
	...
	hint := mustFindHint(t, result.Hints, HintSpawn)
...
func TestExtractorEmitsSelectorDeferHint(t *testing.T) {
	...
	hint := mustFindHint(t, result.Hints, HintDefer)
...
func TestExtractorEmitsWaitHint(t *testing.T) {
	...
	hint := mustFindHint(t, result.Hints, HintWait)
	...
	if hasHint(result.Hints, HintDefer) {
...
func TestExtractorEmitsBranchHint(t *testing.T) {
	...
	if !hasHint(result.Hints, HintBranch) {
