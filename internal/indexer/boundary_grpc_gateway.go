...
func (d *GRPCGatewayDetector) PreparePackage(files []ParsedGoFile, _ []Symbol) []Diagnostic {
	if len(files) == 0 {
		return nil
	}
...
func (d *GRPCGatewayDetector) DetectBoundaries(file ParsedGoFile, symbols []Symbol) ([]BoundaryRoot, []Diagnostic) {
...
func (d *GRPCGatewayDetector) processBlock(block *tree_sitter.Node, file ParsedGoFile, symbols []Symbol, imports map[string]string, inheritedScope map[string]bool, receiverEnv map[string]string, state *grpcGatewayPackageState) ([]BoundaryRoot, []Diagnostic) {
...
func (d *GRPCGatewayDetector) handleCall(call *tree_sitter.Node, file ParsedGoFile, symbols []Symbol, imports map[string]string, scope map[string]bool, receiverEnv map[string]string, state *grpcGatewayPackageState) (*BoundaryRoot, Diagnostic) {
...
func (d *GRPCGatewayDetector) packageKey(file ParsedGoFile) string {
