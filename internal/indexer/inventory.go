...
// Build constructs a repository.Inventory from workspace scan output.
func (InventoryBuilder) Build(workspaceID string, scan scannerport.ScanWorkspaceResult) repository.Inventory {
