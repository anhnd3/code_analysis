...
func (d *NetHTTPDetector) PreparePackage(files []ParsedGoFile, _ []Symbol) []Diagnostic {
	if len(files) == 0 {
		return nil
	}
...
func (d *NetHTTPDetector) DetectBoundaries(file ParsedGoFile, symbols []Symbol) ([]BoundaryRoot, []Diagnostic) {
...
func (d *NetHTTPDetector) processBlock(block *tree_sitter.Node, file ParsedGoFile, symbols []Symbol, imports map[string]string, inheritedScope map[string]bool, receiverEnv map[string]string, state *netHTTPPackageState) ([]BoundaryRoot, []Diagnostic) {
...
func (d *NetHTTPDetector) handleCall(call *tree_sitter.Node, file ParsedGoFile, symbols []Symbol, imports map[string]string, scope map[string]bool, receiverEnv map[string]string, state *netHTTPPackageState) (*BoundaryRoot, Diagnostic) {
...
func (d *NetHTTPDetector) packageKey(file ParsedGoFile) string {
