...
func New(cfg config.Config, logger *slog.Logger) (*Application, error) {
	...
	inventorySvc := inventoryidx.New()
	scanWorkflow := scanworkflow.New(workspaceScanSvc, inventorySvc, artifactStore, snapshotManageSvc)
	...
	factsIndexWorkflow := indexworkflow.New(scanWorkflow, symbolIdx, boundaryDetectSvc, snapshotManageSvc, artifactStore, cfg.ArtifactRoot)
